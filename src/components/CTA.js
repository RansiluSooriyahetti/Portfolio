      ...
      <Stack spacing={{ base: "8", md: "10" }}>
        <Stack spacing={{ base: "4", md: "5" }} align="center">
          ...
          <Text color="gray.700" maxW="2xl" textAlign="center" fontSize="md">
            I have spent enough time with simple and complex full fleged
            projects. I have created websites and database/backend on cloud.I
        ...
        >
          <Button
            ...
            bg={"primary.800"}
            color="white"
            href={"mailto:ransilusooriyahetti@gmail.com"}
